...
INSERT INTO `warehouse`.`invoice_line_item` (`invoice_line_item_id`, `price`, `quantity`, `value1`, `invoice_id`, `product_id`) VALUES ('1', '10', '1', '10', '1', '1');
INSERT INTO `warehouse`.`warehouse_card_analytics` (`warehouse_card_analytics_id`, `ordinal_number`, `price`, `quantity`, `traffic_direction`, `traffic_type`, `value`, `invoice_line_item_id`, `product_card_id`) VALUES (1, 1, 10, 1, 'U', 'PR', 10, 1, 1);
